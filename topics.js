const topics = [
  ...
  "서버리스 아키텍처를 활용한 프로젝트나 응용 사례를 언급해보세요.",
  "서버리스 컴퓨팅과 관련된 보다 고급 주제에 대해 언급해보세요 (예: 서버리스 데이터베이스, 서버리스 함수 프레임워크 등).",
  "마이크로서비스 아키텍처란 무엇인가요?",
  ...
  "마이크로서비스 아키텍처를 활용한 프로젝트나 응용 사례를 언급해보세요.",
